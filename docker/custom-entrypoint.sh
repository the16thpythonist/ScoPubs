#!/usr/bin/env bash
# It is important that "-e" is not set! Because that will cause the script to fail when "core is-installed" has a
# exit code 1 in case the thingy is not installed
set -Euo pipefail

# === WAITING FOR DATABASE ===
python3 "$WP_PATH/wait_for_mysql.py"
echo "database connection established!"

# === INSTALLING WORDPRESS DATABASE ===
$WPCLI_COMMAND core is-installed
INSTALLED=$?
